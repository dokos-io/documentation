...
![Image permettant de visualiser la partie publier sur le site web](/publierarticlesiteweb.png)
...
![Image permettant de visualiser la partie "voir l'article du site web"](/voirarticlesiteweb.png)
...
::callout{icon="i-heroicons-light-bulb"}
Pour plus d’informations, rendez-vous sur la page Paramètres du site web dans la documentation. 
::
