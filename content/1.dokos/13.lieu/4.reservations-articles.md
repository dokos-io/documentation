...
faq:
  ...
  items:
    - label: Comment configurer une notification par e-mail lors de l'annulation d'une réservation dans Dokos ?
      content: Pour configurer une notification par e-mail lors de l'annulation d'une réservation dans Dokos, créez une nouvelle notification en allant dans Outils > Notifications. Envoyer une notification lors du changement de valeur du champ « Statut » de la réservation d’articles, avec la condition que le nouveau statut soit "Cancelled" et spécifiez les destinataires et le modèle de courriel à utiliser. Cela garantira que les utilisateurs concernés recevront un e-mail automatique en cas d'annulation.
       <a href="https://community.dokos.io/t/notification-mail-annulation-reservation/1033/2">Voir sur le forum</a>
...
![Cette image permet de visualiser les paramètres du lieu.](/Param%C3%A8tres%20du%20lieu%20.png)
...
![Cette image permet de visualiser les unités de mesure dans les paramètres du lieu.](/param%C3%A8tre%20lieu%20-%20UDM.png)
...
::tour{demo="Mappemonde" doctype="item-booking-calendarm"}
...
![Cette image permet de visualiser les deux calendriers de la démo.](/Deux%20calendriers.png)
...
![Cette image permet de visualiser une ressource réservable.](/Ressource%20reservable.png)
...
> Rendez-vous sur la page [**Badges**](//dokos/lieu/badges){rel="nofollow,noopener,noreferrer" target="_blank"}
...
![Cette image permet de visualiser une réservation d'article.](/R%C3%A9servation%20d'article%20.png)
...
![Cette image permet de visualiser les paramètres du portail.](/Param%C3%A8tres%20portail.png)
...
![Cette image permet de visualiser la vue portail : Booking](/Vue%20portail.png)
...
![Cette image permet de visualiser la vue portail pour réserver des ressources.](/vue%20portail%202.png)
...
![Cette image permet de visualiser comment ajouter une ressource réservable dans un événement.](/%C3%A9v%C3%A9nements.png)
