...
1. Calendrier par unité de mesure

Exemple : Différents calendriers par unité de mesure
...
* Calendrier à la demi-journée
  ...
  * Configuration des créneaux :
    ...
    Après-midi : 13:30 - 18:30.
2. Calendrier par article

Exemple : Différents calendriers par article

* Cas d'utilisation : Vous louez une salle de réunion et un bureau, chacun ayant des horaires différents.

* Calendrier pour la salle de réunion
...
3. Combinaison article et unité de Mesure

Il est également possible de combiner des critères spécifiques d'articles et d'unités de mesure pour configurer des calendriers plus détaillés. Par exemple, si vous avez une salle de conférence qui peut être réservée à la journée entière, mais aussi à la demi-journée, vous pourriez configurer :

* Calendrier pour la salle de conférence à la journée :
  * Unité de mesure : Journée.
  * Article : Salle de conférence.
  * Configuration des créneaux :

   Lundi à Vendredi : 08:00 - 18:00.
* Calendrier pour la salle de conférence à la demi-journée :
  * Unité de mesure : Demi-journée.
  * Article : Salle de conférence.
  * Configuration des créneaux :
