...
Le module Événements et Réservations de ressources est une extension du module Lieu, installé par défaut sur Dokos. Les clients utilisant notre solution cloud peuvent demander l'installation du module Événements et Réservations de Ressources en contactant notre équipe à l'adresse <support@dokos.io>.
::
...
## 10. Paramètres de réservation de ressources
