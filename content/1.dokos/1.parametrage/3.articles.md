---
title: Les articles 
description: Optimisez la gestion de vos stocks et simplifiez vos opérations commerciales grâce à Dokos, notre fonctionnalité d'article complète vous permettra de suivre, gérer et analyser efficacement tous vos produits et services.
...
Un article représente un produit, un service ou une ressource essentielle pour une entreprise, que ce soit dans le cadre de ses achats, de ses ventes ou de ses opérations internes. 

C'est la donnée fondamentale utilisée pour la facturation des clients et des fournisseurs ainsi que pour la gestion de la production. 

Dans le contexte des activités commerciales, un article est doté de divers attributs tels que son prix, sa description, sa disponibilité en stock, et d'autres informations pertinentes. 

## 1. Créer un article
 
 > Vente > Données de vente > Articles 
