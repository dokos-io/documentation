...
- **Liste de prix par défaut**: Sélectionnez une liste de prix applicable à ce client s'il ne s'agit pas de la liste de prix par défaut ou de celle associée à sont groupe de clients. :right-arrow: [Voir la documentation concernant les listes de prix](/dokos/parametrage/prix)
