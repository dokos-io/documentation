...
2. **Titre**
* Entrez le titre de la nouvelle catégorie du blog. Ce champ est obligatoire.

    **Exemple** : "Actualités de l'Entreprise"
3. **Description**
...
![Cette image permet de visualiser le formulaire pour créer un nouvel article de blog.](/New%20article%20blog.png)

#### 4.1. Remplir le formulaire de création

1. **Titre**
* Entrez le titre de l'article de blog. 

  **Exemple** : "Découvrez notre Nouveau Tiers Lieu"
2. **Catégorie du blog**
...
5. **Intro du blog**
* Une introduction ou un résumé de l'article. 

  **Exemple** : "Rejoignez-nous pour découvrir notre nouveau tiers lieu, un espace de collaboration et de créativité."

6. **Description pour la page de recherche**
* Une courte description pour la page de résultats de recherche, en texte brut. 
 
  **Exemple** : "Découvrez notre espace collaboratif dédié à la créativité et à l'innovation."
7. **Type de Contenu**
