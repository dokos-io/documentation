...
![Cette image permet de visualiser le formulaire : Pied de page.](/4.%20Pied%20de%20page.png)
...
![Cette image permet de visualiser le formulaire : Intégration.](/5.%20Integration.png)
...
- **ID Google Analytics :** Entrez votre identifiant Google Analytics ici. Google Analytics est un outil pour suivre et analyser le trafic de votre site web.
