...
- Activation de la redirection vers une URL personnalisée lors du clic sur une notification par TechnicalShree [dodock#22956](https://gitlab.com/dokos/dodock/pull/22956) [MR #940](https://gitlab.com/dokos/dodock/-/merge_requests/940)
- Révision de l'état du flux de travail par rtdany10 [dodock#23207](https://gitlab.com/dokos/dodock/pull/23207) [MR #938](https://gitlab.com/dokos/dodock/-/merge_requests/938)
...
- Autorisation de la définition des champs comme non nuls par akhilnarang [dodock#22804](https://gitlab.com/dokos/dodock/pull/22804) [MR #934](https://gitlab.com/dokos/dodock/-/merge_requests/934)
- Autorisation de l'utilisation de `print()` dans `safe_exec()` par akhilnarang [dodock#23084](https://gitlab.com/dokos/dodock/pull/23084) [MR #932](https://gitlab.com/dokos/dodock/-/merge_requests/932)
- Ajout de la vue d'image dans le bloc de raccourcis du workspace par sibikumarkuppusamy [dodock#23041](https://gitlab.com/dokos/dodock/pull/23041) [MR #931](https://gitlab.com/dokos/dodock/-/merge_requests/931)
- Mise à jour de multi_select_dialog.js par hyaray [dodock#23261](https://gitlab.com/dokos/dodock/pull/23261) [MR #922](https://gitlab.com/dokos/dodock/-/merge_requests/922)
- Option Bootstrap uniquement si la base de données et l'utilisateur sont gérés de manière externe à Bench par blaggacao [dodock#23170](https://gitlab.com/dokos/dodock/pull/23170) [MR #904](https://gitlab.com/dokos/dodock/-/merge_requests/904)
- Implémentation du mappage dans la table enfant par blaggacao [dodock#22592](https://gitlab.com/dokos/dodock/pull/22592) [MR #903](https://gitlab.com/dokos/dodock/-/merge_requests/903)
...
- Autorisation de l'édition au format numérique dans ControlFloat [dodock#23143](https://gitlab.com/dokos/dodock/pull/23143) [MR #891](https://gitlab.com/dokos/dodock/-/merge_requests/891)
- Application de filtres aux champs de lien via le générateur de formulaires par RitvikSardana [dodock#22844](https://gitlab.com/dokos/dodock/pull/22844) [MR #890](https://gitlab.com/dokos/dodock/-/merge_requests/890)
...
- Filtres de date dans le suivi des modifications par GursheenK [dodock#22684](https://gitlab.com/dokos/dodock/pull/22684) [MR #857](https://gitlab.com/dokos/dodock/-/merge_requests/857)
- Autorisation de la suppression et ajout de la fonction de suppression de dossier pour les pages par Vishnu7025 [dodock#23077](https://gitlab.com/dokos/dodock/pull/23077) [MR #842](https://gitlab.com/dokos/dodock/-/merge_requests/842)
- Importation du scss depuis node_modules dans les applications également par blaggacao [dodock#22519](https://gitlab.com/dokos/dodock/pull/22519) [MR #818](https://gitlab.com/dokos/dodock/-/merge_requests/818)
- Ajout du bouton "Graphique du tableau de bord" par Vishnu7025 [dodock#22960](https://gitlab.com/dokos/dodock/pull/22960) [MR #814](https://gitlab.com/dokos/dodock/-/merge_requests/814)
- Option pour définir le type de fichier par défaut de manière programmatique dans export de données par hyaray [dodock#22658](https://gitlab.com/dokos/dodock/pull/22658) [MR #808](https://gitlab.com/dokos/dodock/-/merge_requests/808)
- Documentation de Document.remove_tag par gavindsouza [dodock#22970](https://gitlab.com/dokos/dodock/pull/22970) [MR #802](https://gitlab.com/dokos/dodock/-/merge_requests/802)
...
- Versionnement de l'API et API v2 (bêta) par ankush [dodock#22300](https://gitlab.com/dokos/dodock/pull/22300) [MR #732](https://gitlab.com/dokos/dodock/-/merge_requests/732)
- Limite de fréquence des connexions basée sur l'adresse IP également par ankush [dodock#22774](https://gitlab.com/dokos/dodock/pull/22774) [MR #741](https://gitlab.com/dokos/dodock/-/merge_requests/741)
- Actualisation automatique lorsque l'utilisateur met à jour le thème par shridarpatil [dodock#22771](https://gitlab.com/dokos/dodock/pull/22771) [MR #737](https://gitlab.com/dokos/dodock/-/merge_requests/737)
- E-mail depuis le champ 'Table Multiselect' dans notification par sayedayman203 [dodock#22733](https://gitlab.com/dokos/dodock/pull/22733) [MR #719](https://gitlab.com/dokos/dodock/-/merge_requests/719)
- Autorisation de la suppression et ajout de la fonction de suppression de dossier pour les pages par Vishnu7025 [dodock#23077](https://gitlab.com/dokos/dodock/pull/23077) [MR #842](https://gitlab.com/dokos/dodock/-/merge_requests/842)
- Importation du scss depuis node_modules dans les applications également par blaggacao [dodock#22519](https://gitlab.com/dokos/dodock/pull/22519) [MR #818](https://gitlab.com/dokos/dodock/-/merge_requests/818)
- Ajout du bouton "Graphique du tableau de bord" par Vishnu7025 [dodock#22960](https://gitlab.com/dokos/dodock/pull/22960) [MR #814](https://gitlab.com/dokos/dodock/-/merge_requests/814)
- Option pour définir le type de fichier par défaut de manière programmatique dans export de données par hyaray [dodock#22658](https://gitlab.com/dokos/dodock/pull/22658) [MR #808](https://gitlab.com/dokos/dodock/-/merge_requests/808)
...
- Versionnement de l'API et API v2 (bêta) par ankush [dodock#22300](https://gitlab.com/dokos/dodock/pull/22300) [MR #732](https://gitlab.com/dokos/dodock/-/merge_requests/732)
- Limite de fréquence des connexions basée sur l'adresse IP également par ankush [dodock#22774](https://gitlab.com/dokos/dodock/pull/22774) [MR #741](https://gitlab.com/dokos/dodock/-/merge_requests/741)
- Mise à jour automatique lors de la modification du thème par shridarpatil [Pull Request #22771](https://gitlab.com/dokos/dodock/pull/22771) [MR #737](https://gitlab.com/dokos/dodock/-/merge_requests/737)
- Notification par e-mail à partir du champ 'Table Multiselect' par sayedayman203 [Pull Request #22733](https://gitlab.com/dokos/dodock/pull/22733) [MR #719](https://gitlab.com/dokos/dodock/-/merge_requests/719)
- Autoriser les clés de connexion sociale à contrôler les inscriptions par ankush [Pull Request #22724](https://gitlab.com/dokos/dodock/pull/22724) [MR #716](https://gitlab.com/dokos/dodock/-/merge_requests/716)
- Déplacer les "j'aime" vers la droite, masquer les affectations vides - PR #22659 [Pull Request #22659](https://gitlab.com/dokos/dodock/pull/22659) [MR #712](https://gitlab.com/dokos/dodock/-/merge_requests/712)
- Activer `tabSelect` pour awesomplete par akhilnarang [Pull Request #22687](https://gitlab.com/dokos/dodock/pull/22687) [MR #690](https://gitlab.com/dokos/dodock/-/merge_requests/690)
- Activer `tabSelect` pour awesomplete par akhilnarang [Pull Request #22636](https://gitlab.com/dokos/dodock/pull/22636) [MR #677](https://gitlab.com/dokos/dodock/-/merge_requests/677)
- Améliorer le développement d'OpenID Connect par blaggacao [Pull Request #22330](https://gitlab.com/dokos/dodock/pull/22330) [MR #670](https://gitlab.com/dokos/dodock/-/merge_requests/670)
...
- Liste d'autorisation globale pour les extensions de fichiers par ankush [Pull Request #22531](https://gitlab.com/dokos/dodock/pull/22531) [MR #634](https://gitlab.com/dokos/dodock/-/merge_requests/634)
- Renommer le champ 'fieldname' du champ personnalisé par ankush [Pull Request #22513](https://gitlab.com/dokos/dodock/pull/22513) [MR #625](https://gitlab.com/dokos/dodock/-/merge_requests/625)
- Vérifier les autorisations d'écriture sur les pièces jointes au doc(type) par barredterra [Pull Request #22500](https://gitlab.com/dokos/dodock/pull/22500) [MR #621](https://gitlab.com/dokos/dodock/-/merge_requests/621)
- Provision pour `set_route` pour la carte numérique personnalisée par DaizyModi [Pull Request #21806](https://gitlab.com/dokos/dodock/pull/21806) [MR #605](https://gitlab.com/dokos/dodock/-/merge_requests/605)
- Ajouter des icônes personnalisées avec le crochet `app_include_icons` par cogk [Pull Request #22254](https://gitlab.com/dokos/dodock/pull/22254) [MR #603](https://gitlab.com/dokos/dodock/-/merge_requests/603)
- Mise à jour en bloc des champs sélectionnés triés par libellés traduits par FHenry [Pull Request #22318](https://gitlab.com/dokos/dodock/pull/22318) [MR #602](https://gitlab.com/dokos/dodock/-/merge_requests/602)
- Ajouter l'argument json amont à la requête de fabrication dans les intégrations par blaggacao [Pull Request #22462](https://gitlab.com/dokos/dodock/pull/22462) [MR #595](https://gitlab.com/dokos/dodock/-/merge_requests/595)
...
- Ajouter un raccourci d'impression par niraj2477 [Pull Request #22471](https://gitlab.com/dokos/dodock/pull/22471) [MR #590](https://gitlab.com/dokos/dodock/-/merge_requests/590)
- Voir les requêtes validées dans le journal de la console par shadrak98 [Pull Request #22466](https://gitlab.com/dokos/dodock/pull/22466) [MR #588](https://gitlab.com/dokos/dodock/-/merge_requests/588)
- Ajouter une fonctionnalité d'autocomplétion pour le fuseau horaire de l'utilisateur par cogk [Pull Request #22456](https://gitlab.com/dokos/dodock/pull/22456) [MR #587](https://gitlab.com/dokos/dodock/-/merge_requests/587)
...
- Trier par colonne en cliquant sur le titre de la colonne par cogk [Pull Request #22187](https://gitlab.com/dokos/dodock/pull/22187) [MR #570](https://gitlab.com/dokos/dodock/-/merge_requests/570)
- Ouvrir les détails du fichier à partir de la recherche par barredterra [Pull Request #22108](https://gitlab.com/dokos/dodock/pull/22108) [MR #568](https://gitlab.com/dokos/dodock/-/merge_requests/568)
- Améliorer la réactivité de la liste d'adresses et de contacts par barredterra [Pull Request #22270](https://gitlab.com/dokos/dodock/pull/22270) [MR #563](https://gitlab.com/dokos/dodock/-/merge_requests/563)
- Utiliser le champ de lien pour la recherche dans le gestionnaire des autorisations de rôle par FHenry [Pull Request #22232](https://gitlab.com/dokos/dodock/pull/22232) [MR #560](https://gitlab.com/dokos/dodock/-/merge_requests/560)
- Gestionnaire de rappel `after_response` par ankush [Pull Request #22398](https://gitlab.com/dokos/dodock/pull/22398) [MR #556](https://gitlab.com/dokos/dodock/-/merge_requests/556)
- Journal d'audit par GursheenK [Pull Request #22104](https://gitlab.com/dokos/dodock/pull/22104) [MR #546](https://gitlab.com/dokos/dodock/-/merge_requests/546)
- Taille maximale du fichier configurable à partir des paramètres système par ankush [Pull Request #22384](https://gitlab.com/dokos/dodock/pull/22384) [MR #544](https://gitlab.com/dokos/dodock/-/merge_requests/544)
- #22308 par ankush [Pull Request #22389](https://gitlab.com/dokos/dodock/pull/22389) [MR #548](https://gitlab.com/dokos/dodock/-/merge_requests/548)
- Développer les assignations au survol par barredterra [Pull Request #22337](https://gitlab.com/dokos/dodock/pull/22337) [MR #522](https://gitlab.com/dokos/dodock/-/merge_requests/522)
- Générer dynamiquement le texte de la licence par niraj2477 [Pull Request #22299](https://gitlab.com/dokos/dodock/pull/22299) [MR #516](https://gitlab.com/dokos/dodock/-/merge_requests/516)
...
- Utiliser `functools.cached_property` par sagarvora [Pull Request #22304](https://gitlab.com/dokos/dodock/pull/22304) [MR #511](https://gitlab.com/dokos/dodock/-/merge_requests/511)
- Fusionner la demande de tirage de GHSA-j2w9-8xrr-7g98 [MR #491](https://gitlab.com/dokos/dodock/-/merge_requests/491)
- Remplacer `on_update` dans la communication par ssiyad [Pull Request #22267](https://gitlab.com/dokos/dodock/pull/22267) [MR #505](https://gitlab.com/dokos/dodock/-/merge_requests/505)
- Afficher le titre d'avertissement dans les fichiers publics par barredterra [Pull Request #22242](https://gitlab.com/dokos/dodock/pull/22242) [MR #503](https://gitlab.com/dokos/dodock/-/merge_requests/503)
- Rôle `Desk User` par ankush [Pull Request #22224](https://gitlab.com/dokos/dodock/pull/22224) [MR #476](https://gitlab.com/dokos/dodock/-/merge_requests/476)
- Envoyer un identifiant de demande unique en tant qu'en-tête de réponse par ankush [Pull Request #22218](https://gitlab.com/dokos/dodock/pull/22218) [MR #468](https://gitlab.com/dokos/dodock/-/merge_requests/468)
- Ajout de deux options do_not_make_page et do_not_setup_menu pour l'arborescence par rohitwaghchaure [Pull Request #22190](https://gitlab.com/dokos/dodock/pull/22190) [MR #450](https://gitlab.com/dokos/dodock/-/merge_requests/450)
- Ajouter la sélection rapide de plusieurs lignes avec Maj+Clic [MR #444](https://gitlab.com/dokos/dodock/-/merge_requests/444)
- Tracé de base à l'aide de l'identifiant de trace du moniteur par ankush [Pull Request #22126](https://gitlab.com/dokos/dodock/pull/22126) [MR #435](https://gitlab.com/dokos/dodock/-/merge_requests/435)
- Renvoyer le chemin absolu par barredterra [Pull Request #22142](https://gitlab.com/dokos/dodock/pull/22142) [MR #433](https://gitlab.com/dokos/dodock/-/merge_requests/433)
- Autoriser la réexécution des correctifs en mode développeur [MR #418](https://gitlab.com/dokos/dodock/-/merge_requests/418)
- Améliorer attach_print et permettre d'utiliser sa sortie dans email.make par barredterra [Pull Request #21837](https://gitlab.com/dokos/dodock/pull/21837) [MR #416](https://gitlab.com/dokos/dodock/-/merge_requests/416)
- Journaux de réexécution dans la console système par RitvikSardana [Pull Request #22103](https://gitlab.com/dokos/dodock/pull/22103) [MR #413](https://gitlab.com/dokos/dodock/-/merge_requests/413)
...
- **Prise en charge de Python 3.12 par ankush** [_dodock#22706_](https://gitlab.com/dokos/dodock/pull/22706) **[!961](https://gitlab.com/dokos/dodock/-/merge_requests/961)**
...
- **Restriction de la version de Python à 3.11 uniquement par blaggacao** [_dodock#23229_](https://gitlab.com/dokos/dodock/pull/23229) **[!898](https://gitlab.com/dokos/dodock/-/merge_requests/898)**
- **Formatage automatique des fichiers Vue avec prettier par surajshetty3416** [_dodock#23203_](https://gitlab.com/dokos/dodock/pull/23203) **[!885](https://gitlab.com/dokos/dodock/-/merge_requests/885)**
- **Test d'intégration Smtp en utilisant smtp4dev par ankush** [_dodock#23094_](https://gitlab.com/dokos/dodock/pull/23094) **[!849](https://gitlab.com/dokos/dodock/-/merge_requests/849)**
- **Mise à jour de PyPDF à la version 3.17.0 par bosue** [_dodock#23060_](https://gitlab.com/dokos/dodock/pull/23060) **[!839](https://gitlab.com/dokos/dodock/-/merge_requests/839)**
...
- **Mise à jour de postcss de 8.4.24 à 8.4.31 par dependabot[bot]** [_dodock#22615_](https://gitlab.com/dokos/dodock/pull/22615) **[!687](https://gitlab.com/dokos/dodock/-/merge_requests/687)**
- **Correction du test flaky theme switcher UI** **[!640](https://gitlab.com/dokos/dodock/-/merge_requests/640)**
- **Mise à jour de cypress par surajshetty3416** [_dodock#22505_](https://gitlab.com/dokos/dodock/pull/22505) **[!632](https://gitlab.com/dokos/dodock/-/merge_requests/632)**
...
- **Ignorer les changements d'espacement lors de la comparaison HTML par ankush** [_dodock#22386_](https://gitlab.com/dokos/dodock/pull/22386) **[!545](https://gitlab.com/dokos/dodock/-/merge_requests/545)**
- **Mise à jour de frappe-datatable à la version 1.17.3 par surajshetty3416** [_dodock#22347_](https://gitlab.com/dokos/dodock/pull/22347) **[!528](https://gitlab.com/dokos/dodock/-/merge_requests/528)**
- **Mise à jour des dépendances Python par ankush** [_dodock#22294_](https://gitlab.com/dokos/dodock/pull/22294) **[!506](https://gitlab.com/dokos/dodock/-/merge_requests/506)**
- **Mise à jour de gitpython par ankush** [_dodock#22290_](https://gitlab.com/dokos/dodock/pull/22290) **[!499](https://gitlab.com/dokos/dodock/-/merge_requests/499)**
- Autorisation des pipelines déclenchées par un mainteneur
- **Mise à jour de RestrictedPython à la dernière version par ankush** [_dodock#22258_](https://gitlab.com/dokos/dodock/pull/22258) **[!483](https://gitlab.com/dokos/dodock/-/merge_requests/483)**
- **Autorisation des pipelines à partir des MR externes approuvés** **[!456](https://gitlab.com/dokos/dodock/-/merge_requests/456)**
- **Mise à jour de gunicorn à la dernière version** [_dodock#22086_](https://gitlab.com/dokos/dodock/pull/22086) **[!404](https://gitlab.com/dokos/dodock/-/merge_requests/404)**
