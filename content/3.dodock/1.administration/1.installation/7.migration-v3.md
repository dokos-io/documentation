...
::alert
Si vous souhaitez **installer** Dokos pour la première fois, consultez le [guide d'installation rapide](/fr/getting-started/easy-installation) plutôt que ce guide de migration.
::
