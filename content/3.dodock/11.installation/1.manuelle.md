...
Dans une autre fenêtre de terminal, téléchargez les applications que vous souhaitez installer sur vos sites. 
Ne téléchargez que celles dont vous avez besoin.
...
- Si vous avez un enregistrement DNS configuré qui pointe vers votre serveur : [http://monsite.dokos.cloud](http://monsite.dokos.cloud).
...
::card-grid
  ...
  href: /dodock/administration/domaine
